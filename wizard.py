...
class ImportICD10(Wizard):
    ...
    def transition_import_icd10(self):
        ...
        with file_open(path, mode='rb') as group_file:
        ...
        with file_open(path, mode='rb') as category_file:
        ...
        with file_open(path, mode='rb') as disease_file:
        ...
        with file_open(path, mode='rb') as procedure_file:
